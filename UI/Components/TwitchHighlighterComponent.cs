        ...
        private void HandleStream(object s, DownloadStringCompletedEventArgs e)
        {
            ...
            try
            {
                ...
                if (!Object.Equals(null, Stream) && !String.IsNullOrEmpty(Stream.stream_type) && String.Equals(Stream.stream_type, "live"))
                {
                    ...
                    String data = "[{\"operationName\":\"DashboardCreateVideoBookmark\",\"variables\":{\"input\":{\"broadcastID\":\"" + Stream._id + "\",\"description\":\"" + title + "\",\"medium\":\"live_dashboard_button\",\"platform\":\"web\"}},\"extensions\":{\"persistedQuery\":{\"version\":1,\"sha256Hash\":\"414ea8133c174d305012208b538cec58c27bd6ad5d9598dd0e6c1aeb9044cf08\"}}}]";
